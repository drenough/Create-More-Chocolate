...
public class ModFoods {
    ...
    public static final FoodProperties CHOCOLATE_BUNNY = new FoodProperties.Builder().nutrition(6)
            .saturationMod(0.8f).build();
    public static final FoodProperties CHOCOLATE_EGG = new FoodProperties.Builder().nutrition(4).fast()
            .saturationMod(0.4f).build();
    public static final FoodProperties CHOCOLATE_GLAZED_BERRIES = new FoodProperties.Builder().nutrition(3).fast()
            .saturationMod(0.3f).build();
    public static final FoodProperties CHOCOLATE_PRALINE = new FoodProperties.Builder().nutrition(5)
            .saturationMod(0.2f).build();
    public static final FoodProperties CHOCOLATE_TRUFFLE = new FoodProperties.Builder().nutrition(8)
    ...
    public static final FoodProperties DARK_CHOCOLATE_MARSHMALLOW = new FoodProperties.Builder().nutrition(6)
            .saturationMod(0.5f).build();
    public static final FoodProperties DARK_CHOCOLATE_BUNNY = new FoodProperties.Builder().nutrition(6)
            .saturationMod(0.8f).build();
    ...
    public static final FoodProperties DARK_CHOCOLATE_GLAZED_BERRIES = new FoodProperties.Builder().nutrition(3).fast()
            .saturationMod(0.3f).build();
    public static final FoodProperties DARK_CHOCOLATE_PRALINE = new FoodProperties.Builder().nutrition(5)
            .saturationMod(0.2f).build();
