...
public class ChocolateCakeBlock extends CakeBlock {
    public ChocolateCakeBlock(BlockBehaviour.Properties properties) {
        super(properties);
    }
    ...
    public @NotNull InteractionResult use(@NotNull BlockState state, @NotNull Level level, @NotNull BlockPos pos,
        ...
        if (result.consumesAction()) {
            player.addEffect(new MobEffectInstance(MobEffects.REGENERATION, 200, 0)); // Regeneration for 10 seconds
        }
        return result;
    }
}
